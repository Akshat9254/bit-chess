...
static U64 GENERATED_ZOBRIST_EN_PASSANT_KEYS[SQ_NB + 2];
...
int main(void) {
    ...
    GENERATED_ZOBRIST_EN_PASSANT_KEYS[SQ_NB + 1] = (random_u64() & random_u64() & random_u64());
...
static void print_en_passant_keys(void) {
    ...
    printf("{\n\t");
    for (Square sq = SQ_A1; sq <= SQ_NB + 1; sq++) {
